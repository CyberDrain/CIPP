            ...
            >
              <div>
                ...
                <Typography variant="body2" color="text.secondary">
                  CIPP writes all log entries to an Azure Table Storage table
                  called <code>CippLogs</code>. Each row is partitioned by date
                  using the format <code>YYYYMMDD</code> as the{' '}
                  <code>PartitionKey</code>, with a unique GUID as the{' '}
                  <code>RowKey</code>.
                </Typography>
              </div>
              ...
              <Alert severity="warning">
                <Typography variant="body2">
                  <strong>Always include a PartitionKey filter</strong> in your
                  queries. Azure Table Storage performs a full table scan
                  without one, which is slow and expensive on large tables. Use{' '}
                  <code>eq</code> for a single day or <code>ge</code> /{' '}
                  <code>le</code> for a date range.{' '}
                  <strong>The date partition is in UTC time</strong>, so you may
                  need to use a date range to account for timezone differences.
                </Typography>
              </Alert>
              ...
              <div>
                ...
                >
                  <ul style={{ margin: 0, paddingLeft: '1.5rem' }}>
                    ...
                    <li>
                      <code>Severity</code> — Log level (Info, Warning, Error,
                      Debug)
                    </li>
                    <li>
              ...
              <div>
                ...
                <Typography
                  ...
                  sx={{ mb: 1 }}
                >
                  Append <code>&$filter=</code> to your SAS URL to filter
                  results. Use <code>eq</code>, <code>ne</code>, <code>gt</code>
                  , <code>lt</code>, <code>ge</code>, <code>le</code>, and
                  combine with <code>and</code> / <code>or</code>.
                </Typography>
