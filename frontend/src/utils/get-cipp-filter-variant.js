...
export const getCippFilterVariant = (providedColumnKeys, arg) => {
      ...
      return {
        ...
        filterFn: (row, columnId, filterValue) => {
          ...
          const userSkuIds = userLicenses
            ...
            .filter(Boolean)
          return otherFilters.some((selectedSkuId) =>
            userSkuIds.includes(selectedSkuId)
          )
        },
  ...
  if (
    timeAgoArray.includes(tailKey) ||
    matchDateTime.test(providedColumnKeys)
  ) {
    return {
