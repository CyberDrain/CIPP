...
export const CippQueueTracker = ({
  ...
  if (
    !shouldShowQueue ||
    (!queueId && !lastProcessedQueueId && !persistentQueueData)
  ) {
    return null
  }
            ...
            <>
              ...
              <Box>
                <Typography variant="body2" color="text.secondary" gutterBottom>
                  Progress:{' '}
                  {(persistentQueueData || queueData).PercentComplete?.toFixed(
                    1
                  )}
                  % complete
                </Typography>
                <LinearProgress
                  variant="determinate"
                  value={
                    (persistentQueueData || queueData).PercentComplete || 0
                  }
              ...
              >
                <Typography variant="body2">
                  ...
                  {(persistentQueueData || queueData).TotalTasks || 0}
                </Typography>
                <Typography variant="body2">
                ...
                <Typography variant="body2">
                  ...
                  {(persistentQueueData || queueData).FailedTasks || 0}
                </Typography>
              </Stack>
                ...
                (persistentQueueData || queueData).Tasks.length > 0 && (
                  <>
                    ...
                    >
                      ...
                      >
                        {(persistentQueueData || queueData).Tasks.map(
                          (task, index) => (
                            <Box
                              key={index}
                              sx={(theme) => ({
