...
const UNREACHABLE_BY_DEFAULT = [
  'Power_Platform_Portal_Admin',
  'Power_Platform_Portal_Maker',
]
const defaultVisible = names(Portals).filter(
  (n) => !UNREACHABLE_BY_DEFAULT.includes(n)
)
