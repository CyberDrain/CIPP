...
export const CippAuditLogSearchDrawer = ({
  ...
  const handleCreateSearch = async (data) => {
    ...
    if (Array.isArray(formattedData.RecordTypeFilters)) {
      formattedData.RecordTypeFilters = formattedData.RecordTypeFilters.map(
    ...
    if (Array.isArray(formattedData.OperationsFilters)) {
      formattedData.OperationsFilters = formattedData.OperationsFilters.map(
        (item) => (typeof item === 'object' ? item.value : item)
      )
    }
    ...
    if (Array.isArray(formattedData.UserPrincipalNameFilters)) {
      formattedData.UserPrincipalNameFilters =
        formattedData.UserPrincipalNameFilters.map((item) =>
          typeof item === 'object' ? item.value : item
        )
    }
    ...
    if (Array.isArray(formattedData.IPAddressFilters)) {
      formattedData.IPAddressFilters = formattedData.IPAddressFilters.map(
        (item) => (typeof item === 'object' ? item.value : item)
      )
    }
    ...
    if (Array.isArray(formattedData.ObjectIdFilters)) {
      formattedData.ObjectIdFilters = formattedData.ObjectIdFilters.map(
        (item) => (typeof item === 'object' ? item.value : item)
      )
    }
    ...
    if (Array.isArray(formattedData.AdministrativeUnitFilters)) {
      formattedData.AdministrativeUnitFilters =
        formattedData.AdministrativeUnitFilters.map((item) =>
          typeof item === 'object' ? item.value : item
        )
    }
  ...
  const createSearchFields = [
    ...
    },
    {
      ...
      api: {
        ...
        labelField: (option) =>
          `${option.displayName} (${option.defaultDomainName})`,
        valueField: 'defaultDomainName',
        queryKey: 'ListTenants-AuditDrawer',
        excludeTenantFilter: true,
      },
      validators: {
        validate: (value) => !!value?.value || 'Please select a tenant',
      },
      required: true,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: 'Azure AD Account Logon',
          value: 'azureActiveDirectoryAccountLogon',
        },
        ...
        {
          label: 'Compliance DLP SharePoint',
          value: 'complianceDLPSharePoint',
        },
        ...
        {
          label: 'Information Worker Protection',
          value: 'informationWorkerProtection',
        },
        ...
        {
          label: 'Microsoft Teams Analytics',
          value: 'microsoftTeamsAnalytics',
        },
        ...
        { label: 'Power BI DLP', value: 'powerBIDlp' },
        {
          ...
          value: 'securityComplianceAlerts',
        },
        {
          label: 'Security & Compliance Insights',
          value: 'securityComplianceInsights',
        },
        {
          label: 'Security & Compliance RBAC',
          value: 'securityComplianceRBAC',
        },
        { label: 'SharePoint', value: 'sharePoint' },
        {
          label: 'SharePoint File Operation',
          value: 'sharePointFileOperation',
        },
        {
          label: 'SharePoint List Operation',
          value: 'sharePointListOperation',
        },
        {
          label: 'SharePoint Sharing Operation',
          value: 'sharePointSharingOperation',
        },
        { label: 'Threat Intelligence', value: 'threatIntelligence' },
        {
          label: 'Threat Intelligence ATP Content',
          value: 'threatIntelligenceAtpContent',
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: 'Remove Folder Permissions',
        ...
        {
          label: 'Update Calendar Delegation',
        ...
        {
          label: 'Remove Domain from Company',
        ...
        {
          label: 'Update STS Refresh Token',
