      ...
      <CardContent>
        <Stack spacing={2}>
          <Typography variant="body2">
            This is an advanced setting that allows you to modify the
            permissions used for CPV consent on customer tenants.
          </Typography>
          <Alert color="warning" icon={<WarningAmberOutlined />}>
            The default CIPP-SAM permissions are always applied and cannot be
            removed - you can only layer additional permissions on top of them.
            Use "Reset to CIPP Defaults" to remove all additional permissions
            and return to the built-in defaults.
          </Alert>
