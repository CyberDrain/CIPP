  ...
  return [
    {
      ...
      customDataformatter: (rows, action, formData) => {
        ...
        const bulkRequestData = mailboxArray.map((mailbox) => {
          const permissions = []
          const autoMap =
            formData.autoMap === undefined ? true : formData.autoMap
          ...
          if (
            formData.sendOnBehalfUser &&
            formData.sendOnBehalfUser.length > 0
          ) {
            permissions.push({
    ...
    },
    {
      ...
      confirmText:
        'Are you sure you want to enable the online archive for [UPN]?',
      multiPost: false,
      condition: (row) =>
        row.ArchiveGuid === '00000000-0000-0000-0000-000000000000',
    },
    {
      ...
      customDataformatter: (rows, action, formData) => {
        ...
        const policyName =
          typeof formData.policyName === 'object'
    ...
    },
    {
      ...
      confirmText:
        'Are you sure you want to start the managed folder assistant for [UPN]?',
    },
    {
    ...
    },
    {
      ...
      icon: <MailOutline />,
      condition: (row) =>
        row.recipientTypeDetails === 'UserMailbox' ||
        row.recipientTypeDetails === 'SharedMailbox',
