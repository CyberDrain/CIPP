    ...
    <>
      <CippFormPage
        ...
        customDataformatter={(values) => {
          ...
          if (
            originalAllowExternal !== null &&
            values.allowExternal === originalAllowExternal
          ) {
                    ...
                    dataFilter: (rooms) => {
                      ...
                      const filteredRooms = rooms.filter((room) => {
                        ...
                        const isAlreadyMember =
                          currentMemberEmails.includes(roomEmail)
                    ...
                    dataFilter: (users) => {
                      ...
                      const filteredUsers = users.filter((user) => {
                        ...
                        const isAlreadyOwner =
                          currentOwnerEmails.includes(userEmail)
                    ...
                    Array.isArray(groupInfo.data?.members)
                      ? groupInfo.data.members.map((m) => ({
                          ...
                          value:
                            ...
                            m.mail,
                          addedFields: {
                            id: m.ExternalDirectoryObjectId || m.id,
                          },
                        }))
                      : []
                  }
