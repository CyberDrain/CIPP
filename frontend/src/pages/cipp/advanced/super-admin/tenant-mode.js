      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        <Grid size={{ md: 12, xs: 12 }}>
          <Typography variant="body2" color="textSecondary" sx={{ mb: 3 }}>
            The configuration settings below should only be modified by a super
            admin. Super admins can configure what tenant mode CIPP operates in.
            See{' '}
            <Link
            ...
            for more information on how to configure these modes and what they
            mean.
          </Typography>
        </Grid>
        <Grid size={{ md: 12, xs: 12 }}>
