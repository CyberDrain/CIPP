        ...
        <span>
          ...
          >
            <SvgIcon
              fontSize="small"
              sx={{
                animation: GlobalQuarantinePolicy?.isFetching
  ...
  const actions = [
    {
      ...
      confirmText:
        "Update Quarantine Policy '[Name]'? Policy Name cannot be changed.",
      multiPost: false,
      icon: <Edit />,
      color: 'info',
      ...
      confirmText: (
        <>
          ...
          <Typography variant="body2">
            <strong>Note:</strong> This will delete the Quarantine policy, even
            if it is currently in use.
            <br />
            Removing the Admin and User Access it applies to emails.
          </Typography>
          <Alert severity="warning">
            Confirm the Quarantine is not applied in any of the following
            policies:
