    ...
    confirmText: (
      <>
        <Typography variant="body1">
          Are you sure you want to reset the role mappings for
        ...
        <Alert severity="info">
          This is useful for fixing GDAP relationships that have overlapping
          roles or incorrect group assignments (e.g. using AdminAgents or
          HelpdeskAgents).
        </Alert>
      </>
    ),
