...
const Page = () => {
  ...
  const handleTableRefresh = () => {
    fetchTables.mutate({
      url: apiUrl,
      data: { FunctionName: 'Get-AzDataTable', Parameters: {} },
    })
  }
  ...
  return (
    <Container maxWidth={false} sx={{ width: '100%' }}>
      ...
      <Alert severity="warning" sx={{ mb: 2 }}>
        This page allows you to view and manage data in Azure Tables. This is
        advanced functionality that should only be used when directed by
        CyberDrain support.
      </Alert>
      ...
      <CippApiDialog
        ...
        api={{
          ...
          confirmText: (
            <Stack direction="row" spacing={1}>
              ...
              <Typography variant="body1">
                Are you sure you want to delete this table? This is a
          ...
          type: 'POST',
          data: {
            FunctionName: 'Remove-AzDataTable',
            TableName: selectedTable,
            Parameters: {},
          },
          onSuccess: () => {
