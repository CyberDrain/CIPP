...
const Page = () => {
  ...
  const explainer = (
    <Alert severity="info" sx={{ mb: 2 }}>
      This page collects the alerts from Check by Cyberdrain, a browser plugin
      that blocks AiTM (Adversary-in-the-Middle) attacks. Check provides
      real-time protection against phishing and credential theft attempts. Learn
      more at{' '}
      <Link
        href="https://docs.check.tech"
        target="_blank"
