...
const Page = () => {
  ...
  const actions = [
    ...
    },
    {
      ...
      confirmText:
        'Set [id] to Deprecated. This is a permanent action and cannot be undone.',
      ...
      <CippTablePage
        ...
        tableFilter={
          <CippExpandableAlert severity="info" style={{ marginBottom: 16 }}>
            ...
            allow you to add custom properties to Microsoft Entra directory
            objects.
            <ul>
              <li>
                Schema extensions can only be Deprecated once they are set to
                Available.
              </li>
