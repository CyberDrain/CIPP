...
const Page = () => {
  ...
  const {
    ...
    url: template
      ...
      : null,
    queryKey: template
      ? ['execAppPermissionTemplate', template, refetchKey]
      : null,
    enabled: !!template,
  })
      ...
      <CippPageCard hideBackButton={false} title="Permission Set Not Found">
        <CardContent>
          <Alert severity="error" sx={{ mb: 2 }}>
            The requested permission set does not exist or was not specified.
            Please select a valid permission set from the list.
          </Alert>
          <Button
            variant="contained"
            component={Link}
  ...
  return (
    <CippPageCard
      ...
      title={`Edit Permission Set: ${
        initialPermissions?.TemplateName ||
          ...
          {!isFetching && initialPermissions && (
            <>
              <Typography variant="body2">
                Modify the permissions in this permission set. Any changes will
                affect all applications using this permission set.
              </Typography>
              <Alert severity="info">
              ...
              <Alert severity="info">
                ...
                set. Microsoft Graph is the default Service Principal added and
                you can choose to add additional Service Principals as needed.
                Note that some Service Principals do not have any published
              ...
              <CippAppPermissionBuilder
                ...
                appDisplayName={
                  formControl.watch('templateName') ||
                  initialPermissions?.TemplateName
                }
                key={refetchKey}
              />
