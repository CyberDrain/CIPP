...
Follow this implementation guide to bring your tenants to a security level recommended by CIPP. Currently this security level aligns with multiple recognized standards such as CIS, Essentials 8, and Entra ID SCA. This guide is re-evaluated every three months to keep up with the latest changes in M365.
