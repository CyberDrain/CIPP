      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, flex: 1 }}>
        ...
        <Alert severity="info">
          <Typography variant="body2">
            Leave empty for no limit on JIT admin account duration. When set,
            technicians cannot create JIT admin accounts with durations
            exceeding this limit. This setting applies globally to all tenants.
          </Typography>
        </Alert>
