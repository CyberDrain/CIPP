...
const Page = () => {
  ...
  const addProperty = () => {
    formControl.setValue('properties', [
      ...properties,
      { name: '', type: null },
    ])
  ...
  const formFields = [
    ...
    },
    {
      ...
      required: true,
      placeholder:
        'Select a status for the schema extensions (e.g. InDevelopment, Available)',
      options: [
    ...
    },
    {
      ...
      type: 'autoComplete',
      placeholder:
        'Select the directory object target types for the schema extension',
      required: true,
      multiple: true,
