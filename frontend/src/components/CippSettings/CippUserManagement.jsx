...
export const CippUserManagement = () => {
  ...
  const allRoles = Array.isArray(pageData.AvailableRoles)
    ? pageData.AvailableRoles
    : []
  ...
  const actions = [
    ...
    },
    {
      ...
      confirmText:
        "Are you sure you want to remove this user's access to CIPP?",
      url: '/api/ExecCIPPUsers',
      type: 'POST',
      data: {
        Action: 'Delete',
