...
const Page = () => {
  ...
  const actions = [
    ...
    },
    {
      ...
      confirmText:
        'Are you sure you want to block the sign-in for this equipment mailbox?',
      multiPost: false,
    ...
    },
    {
      ...
      confirmText:
        'Are you sure you want to unblock sign-in for this equipment mailbox?',
      multiPost: false,
      condition: (row) => row.AccountDisabled && !row.IsDirSynced,
    },
    {
  ...
  return (
    <CippTablePage
      ...
      cardButton={
        <CippAddEquipmentDrawer requiredPermissions={cardButtonPermissions} />
      }
    />
  )
}
