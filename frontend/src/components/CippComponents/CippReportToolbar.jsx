...
export const CippReportToolbar = () => {
  ...
  useEffect(() => {
    if (
      reportIdValue?.reportId?.value &&
      reportIdValue.reportId.value !== selectedReport
    ) {
      router.push(
        {
  ...
  const selectedCustomReport =
    selectedReportObject?.type === 'custom' ? selectedReportObject : null
      ...
      {isMobile ? (
        ...
        >
          ...
          <Tooltip
            title={
              isBuiltIn
                ? 'Built-in test suites cannot be edited'
                : 'Edit this custom test suite'
            }
            arrow
          >
            <Box component="span">
          ...
          <Tooltip
            title={
              isBuiltIn
                ? 'Built-in test suites cannot be deleted'
                : 'Delete this custom test suite'
            }
            arrow
          >
            <Box component="span">
          ...
          >
            <List sx={{ py: 0 }}>
              ...
              >
                ...
                <ListItemText
                  primary="Run Tests"
                  secondary="Refresh cached data or re-run tests"
                />
              </ListItemButton>
              <ListItemButton
                sx={{ minHeight: 48 }}
        ...
        fields={[
          {
            ...
            options: [
              ...
              {
                label: 'Tests only (re-run against existing cache)',
                value: 'tests',
              },
            ],
