...
We can generate two password styles when creating a new user or resetting a password: the classic password, with capitalization, numbers, and symbols; or the modern passphrase-style password. A passphrase is more readable and often stronger than randomly generated characters.
