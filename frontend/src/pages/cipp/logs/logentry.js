...
const Page = () => {
  ...
  const logInfo = logData
    ? [
        ...
        {
          name: 'Date & Time',
          data: logData.DateTime
            ? new Date(logData.DateTime).toLocaleString()
            : 'N/A',
        },
  ...
  const standardItems =
    logData?.Standard &&
    typeof logData.Standard === 'object' &&
    !Array.isArray(logData.Standard)
