...
| Accept Deviation / Accept Deviation — Customer Specific | Denied Deviations only. Re-categorises the denied deviation as an accepted (or customer specific) deviation, which counts as compliant in the alignment score.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
