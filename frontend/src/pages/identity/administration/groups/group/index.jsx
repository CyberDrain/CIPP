...
const Page = () => {
  ...
  const groupMemberOfData = bulkData?.find(
    (item) => item.id === 'groupMemberOf'
  )
    ...
    ? [
        {
          ...
          text: (
            <CippCopyToClipBoard
              type="chip"
              text={groupData?.mail || groupData?.mailNickname || 'N/A'}
            />
          ),
        },
        {
      ...
      },
      {
        ...
        defaultvalues: (row) => {
          ...
          return states.length === 1
            ? { isCloudManaged: String(!states[0]) }
            : {}
        },
        fields: [
          {
        ...
        ? [
            {
              ...
              subtext:
                groupMembersData?.body?.error?.message || 'Unknown error',
        ...
        ? [
            {
              ...
              subtext:
                groupMemberOfData?.body?.error?.message || 'Unknown error',
              statusColor: 'error.main',
              statusText: 'Error',
              propertyItems: [],
            },
